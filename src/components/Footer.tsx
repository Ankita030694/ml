...
export default function Footer() {
  return (
    <footer className="bg-[#893F3F] w-full px-4 sm:px-8 md:px-[40px] lg:px-[80px] py-8 md:py-[40px]">
      <div className="flex flex-col lg:flex-row justify-start items-start gap-8 lg:gap-[100px] max-w-[1382px] mx-auto">
        <div className="flex flex-col items-start gap-[8px] w-full lg:w-[610px]">
          <Link href="/">
            <Image
              src="/ml-logo.png"
          ...
          <p className="text-[#FFE3C5] font-[family-name:var(--font-poppins)] text-[14px] font-normal leading-[16px] max-w-[400px]">
            Masala Library by Jiggs Kalra showcases the epicurean lineage of Ancient India, representing culinary excellence from across the country.
          </p>
          <div className="flex items-start gap-[24px] mt-8 md:mt-[62px]">
            <a href="https://instagram.com/masalalibrary" target="_blank" rel="noopener noreferrer" aria-label="Visit our Instagram">
            ...
            <a href="https://linkedin.com/company/masalalibrary" target="_blank" rel="noopener noreferrer" aria-label="Visit our LinkedIn">
        ...
        <div className="flex flex-col sm:flex-row items-start gap-8 sm:gap-12 lg:gap-[200px] w-full lg:w-auto">
          <div className="flex flex-col items-start gap-[32px] w-full sm:w-[164px]">
            <h3 className="text-[#ffffff] font-[family-name:var(--font-poppins)] text-[20px] md:text-[22px] font-medium leading-[22px]">
              Quick Links
            </h3>
            <div className="flex flex-col items-start gap-[16px] w-full">
              ...
              <Link href="/reservation" className="text-[#FFE3C5] font-[family-name:var(--font-poppins)] text-[16px] md:text-[18px] font-medium leading-[18px] no-underline">
                Reservation
              </Link>
          ...
          <div className="flex flex-col items-start gap-[32px] w-full sm:w-auto">
            <h3 className="text-[#ffffff] font-[family-name:var(--font-poppins)] text-[20px] md:text-[22px] font-medium leading-[22px]">
              Legal
            </h3>
            <div className="flex flex-col items-start gap-[16px] w-full">
