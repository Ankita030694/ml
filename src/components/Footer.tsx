...
export default function Footer() {
  return (
    <footer className="bg-[#512904] w-full px-[80px] py-[40px]">
      <div className="flex justify-between items-start max-w-[1382px] mx-auto">
        <div className="flex flex-col items-start gap-[8px] w-[410px]">
          <Image
            src="/ml-logo.png"
          ...
          <div className="flex items-start gap-[24px] mt-[62px]">
        ...
        <div className="flex items-start gap-[200px]">
          <div className="flex flex-col items-start gap-[32px] w-[164px]">
            <h3 className="text-[#AC5E14] font-[family-name:var(--font-poppins)] text-[22px] font-medium leading-[22px]">
              Quick Links
            </h3>
            <div className="flex flex-col items-start gap-[16px] w-full">
              <a href="#home" className="text-[#FFE3C5] font-[family-name:var(--font-poppins)] text-[18px] font-medium leading-[18px] no-underline">
                Home
              </a>
              <a href="#about" className="text-[#FFE3C5] font-[family-name:var(--font-poppins)] text-[18px] font-medium leading-[18px] no-underline">
                About
              </a>
              <a href="#reservation" className="text-[#FFE3C5] font-[family-name:var(--font-poppins)] text-[18px] font-medium leading-[18px] no-underline">
                Reservation
              </a>
              <a href="#contact" className="text-[#FFE3C5] font-[family-name:var(--font-poppins)] text-[18px] font-medium leading-[18px] no-underline">
                Contact
              </a>
            </div>
          </div>

          <div className="flex flex-col items-start gap-[32px] w-[115px]">
            <h3 className="text-[#AC5E14] font-[family-name:var(--font-poppins)] text-[22px] font-medium leading-[22px]">
              Legal
            </h3>
            <div className="flex flex-col items-start gap-[16px] w-full">
              <a href="#privacy" className="text-[#FFE3C5] font-[family-name:var(--font-poppins)] text-[18px] font-medium leading-[18px] no-underline">
                Privacy
              </a>
              <a href="#terms" className="text-[#FFE3C5] font-[family-name:var(--font-poppins)] text-[18px] font-medium leading-[18px] no-underline">
                Terms
              </a>
              <a href="#cookies" className="text-[#FFE3C5] font-[family-name:var(--font-poppins)] text-[18px] font-medium leading-[18px] no-underline">
                Cookies
              </a>
              <a href="#licenses" className="text-[#FFE3C5] font-[family-name:var(--font-poppins)] text-[18px] font-medium leading-[18px] no-underline">
                Licenses
              </a>
            </div>
          </div>
